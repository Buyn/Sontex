:PROPERTIES:
:header-args: :tangle sandbox.py :comments link
:END:
* dd
** 00
#+begin_src python
...
** test file sh
:PROPERTIES:
:header-args: :tangle sandbox.sh :comments link
:END:
#+begin_src sh
print("test 2!")
#+end_src

** test file clojure js
:PROPERTIES:
:header-args: :tangle sandbox.cljs
:END:
****** +original+
#+begin_src clojure 
print("test 2!")
...
* DONE 2025-05-02 append list
CLOSED: [2025-05-11 Sun 15:12]
:PROPERTIES:
...
(find-file-other-frame "/home/buyn/Dev/Python/Sontex/Src/sandbox.py")

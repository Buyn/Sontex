...
# Мінімальна частка середнього питомого споживання
    ...
    def test_set_global_coefficients(self):
      self.assertEqual(gk_Qfun_sys, 0)
      self.assertEqual(gk_Qmzk, 0)
      set_global_coefficients(gk_Qfun_sys = 0)
      self.assertEqual(gk_Qfun_sys, 0)
      set_global_coefficients(gk_Qmzk = 0)
      self.assertEqual(gk_Qmzk, 0)
      set_global_coefficients(gk_Qmzk = 10, gk_Qfun_sys = 10)
      self.assertEqual(gk_Qfun_sys, 10)
      self.assertEqual(gk_Qmzk, 10)
